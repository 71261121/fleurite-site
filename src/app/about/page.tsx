        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Founder of the Fleurite Reset System
            </p>
          </div>

          {/* Story */}
          <section className="mb-16 bg-card rounded-2xl p-8 md:p-12 border border-gray-300">
            ...
            <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
              ...
              <p>
                The Fleurite Reset System isn't theory. It's nine years of proof that when you work WITH your cycle instead of against it, everything becomes possible.
              </p>
            </div>
          </section>
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-card rounded-xl p-6 border border-gray-300">
                <div className="text-3xl font-bold text-black mb-3">Explain</div>
              ...
              <div className="bg-card rounded-xl p-6 border border-gray-300">
                <div className="text-3xl font-bold text-black mb-3">Reset</div>
              ...
              <div className="bg-card rounded-xl p-6 border border-gray-300">
                <div className="text-3xl font-bold text-black mb-3">Align</div>
          ...
          <section className="mb-16 bg-muted rounded-2xl p-8 md:p-12">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="text-4xl font-black text-black mb-2">9 Years</div>
                <p className="text-muted-foreground">of research and real-world application</p>
              </div>
              <div className="text-center">
                <div className="text-4xl font-black text-black mb-2">5,000+</div>
                <p className="text-muted-foreground">women regained their energy</p>
              </div>
              <div className="text-center">
                <div className="text-4xl font-black text-black mb-2">9,200</div>
                <p className="text-muted-foreground">viral shares (top 1% content)</p>
              </div>
              <div className="text-center">
                <div className="text-4xl font-black text-black mb-2">7 Days</div>
          ...
          {/* CTA */}
          <section className="text-center bg-white rounded-2xl p-12 border border-gray-300">
            ...
            <a
              href="/#products"
              className="inline-block bg-black text-white px-8 py-4 rounded-full font-bold hover:bg-gray-900 transition-colors"
            >
              Get The System — $27
            </a>
          </section>
