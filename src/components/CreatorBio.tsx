    ...
    <section className="py-20 bg-white scroll-mt-20" id="about">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto">
          {/* Author Card */}
          <div className="flex items-center gap-4 mb-8 bg-gray-50 rounded-2xl p-6 border border-gray-100">
            <div className="w-16 h-16 bg-gradient-to-br from-rose-400 to-amber-400 rounded-full flex items-center justify-center flex-shrink-0">
          ...
          <div className="text-gray-600 space-y-6 text-lg leading-relaxed">
            ...
            <p>
              So I created the tools I wished I had: <span className="font-semibold text-rose-700">exact words for exact moments</span>.
