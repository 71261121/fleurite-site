      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          {problems.map((problem, index) => (
            <div
              key={index}
              className="bg-muted rounded-2xl p-8 hover:shadow-lg transition-shadow border border-muted"
            >
        ...
        <div className="text-center bg-gradient-to-r from-rose-50 to-gold-50 rounded-2xl p-8 md:p-12">
          <p className="text-xl md:text-2xl text-foreground font-medium leading-relaxed max-w-4xl mx-auto">
            You've tried <span className="font-bold text-pine-600">being more chill</span>.
            You've tried <span className="font-bold text-pine-600">giving him space</span>.
            You've tried <span className="font-bold text-pine-600">playing it cool</span>.
          </p>
